...
%
% paste from
% /Users/luke/Dropbox/proj/rudolf/paper/metadata_table_data.tex
...
age-dateable stars in Table~\ref{tab:v05}.  $N_{\rm Gaia}$: number of
...
neglected.  Some studies appear multiple times when multiple tables
from the analysis were included in the concatenation.
}
\vspace{-0.5cm}
\end{deluxetable*}
