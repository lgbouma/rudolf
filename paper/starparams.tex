...
\hline 
$\rho_{\rm B}$ & Apparent separation of \dotfill & 0.16 $\pm 0.02$ &  9 \\
                    & \hspace{3pt} primary and secondary (as) &  \\
$\theta_{\rm B}$ & Separation angle (deg)\dotfill & 91.9 $\pm 2.5$ & 9 \\
$\Delta m_{832}$ & Mag difference (`Alopeke 832\,nm)\dotfill & 3.1 $\pm 0.1$ & 9 \\
$\Delta m_{Kp}$ & Mag difference (NIRC2 Kp)\dotfill & 2.5 $\pm 0.2$ & 10 \\
$\rho_{\rm B}$ & Apparent separation of \dotfill & 53 $\pm 7$ &  1,4,9 \\
