...
\tablecomments{
  ...
  1627B, where $F_1$ is the flux from the primary, and $F_2$ is that from the
  secondary; the mean and standard deviation of $R_{\rm p}=3.36\pm0.18$ quoted in the text
  includes this correction, assuming $(F_1+F_2)/F_1\approx 1.015$.
%
