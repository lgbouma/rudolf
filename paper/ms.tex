...
\begin{figure*}[t]
	\begin{center}
		...
		\subfloat{
			...
			\includegraphics[width=0.49\textwidth]{f15b.pdf}
		}
    ...
    against the LDB-age of IC\,2602.  {\bf todo: caption improve.}.
   \label{fig:age}
	}
\end{figure*}
...
%FIXME TODO REFERENCE LOWER PANELS
...
For photometric and astrometric binaries, see the appendix!
