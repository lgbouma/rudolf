...
\begin{figure*}[t]
  ...
  (gray panels) and TESS (colored points) observed portions of the
  cluster.  Naked-eye stars ($m_{\rm V}<6.5$) are shown in gray; four
  of them (orange points) have their names shown.  Kepler\,1627 (green
...
\begin{figure*}[t]
	...
	\vspace{-0.7cm}
	\caption{
    {\bf \sn\ light curve over 100 days.}  
...
\begin{figure*}[t]
    ...
    variability removed.}  
    The 1-$\sigma$ model uncertainties and the median model are shown
