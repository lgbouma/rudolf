...
\begin{figure}[t]
    ...
    \sn\ (bottom row) are computed assuming that every star has the
...
\citet{mcquillan_rotation_2014} for 28 of these stars; for these cases, we
...
of \sn\ to the main cluster isochrone on the Gaia CAMD (Figure~\ref{fig:age}).
...
This fairly contrived geometry would be needed in order to
explain why the starspot crossings could add up coherently.
