...
observed using Keck/HIRES during the night of 7 Aug 2021 (UT).  We
...
from Table~\ref{tab:starparams}, and the jitter term is included.
...
ruled out on this basis.  More data will be needed however to
...
precise level of high-energy irradiation incident on the planet would
also help in clarifying the expected outflow rate \citep[{\it
e.g.},][]{poppenhaeger_2021}.  Finally, perhaps the most challenging,
but also the most informative measurement would be to determine the
planet's mass.  This might be possible either through detailed timing
analyses of the Kepler data, or through a high-cadence multi-color
radial velocity campaign.  Measured at sufficient precision, the mass
could yield constraints on both the planet's composition and its
...
with ancilliary rotation periods and spectroscopy \citep[{\it
