...
\begin{figure*}[t]
    ...
    30 minute cadence.  The {\it top panel} shows the largest
    signal, induced by starspots and plages.  The model for the
    stellar variability (orange line) is subtracted in the {\it
    bottom panel}, highlighting the transits of \pn, as well as other
