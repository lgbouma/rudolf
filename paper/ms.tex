...
\begin{abstract}
  Kepler\,1627 is an active G8V star previously found to host a
  $3.56\pm 0.04\,R_\oplus$ mini-Neptune on a 7.2\,day orbit.  The star
  was selected for observation by the Kepler satellite because it is
  nearby and it resembles the Sun.  Combining data from the Gaia
  satellite with rotation periods from TESS, we show that Kepler\,1627
  is a member of the \cn.  Based on isochronal and gyrochronal
  evidence, the cluster is $30\pm XX$\,Myr old.  Based on archival
  NIRC2 imaging, we also note the existence of a low-mass stellar
  companion. Our analysis advances Kepler\,1627Ab as the youngest
  planet with a precise age detected by the main Kepler mission.
  Newly derived ages from Gaia offer the opportunity to significantly
  expand the census of age-dated planets -- we offer a literature
  concatenation of young stars to support this effort.  The properties
  of \pn\ may also help clarify how the orbits and atmospheres of the
...
obliquity (CITEP,CITEP).  A transmission
