...
pre-main-sequence M dwarfs of the \cn\ were also seen to be ``below''
UCL and ``above'' the Pleiades.}  To turn this heuristic interpolation
...
half-period harmonic.  We therefore adopted a general stance of
skepticism for TESS rotation periods exceeding 10 days, and used the
...
g\,cm}^{-3}$.  This is still in tension with the data.} While the planet
...
e.g.},][]{zhou_2021_tois}.  \replaced{However,}{However, it seems that} smaller planets could have been
detected: \added{based on the per-target detection contours, }the Kepler pipeline's median completeness extended to
...
in the \sn\ light curve over the relevant transit timescales
...
the planetary interior, leading to a $\sim$10$^8$ year Kelvin-Helmholtz
...
could include that it is abnormally massive, or that it has an abnormally
