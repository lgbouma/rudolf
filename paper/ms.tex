...
\begin{abstract}
  ...
  from a Keck/HIRES transit we find that the planet is
  ...
  Gaia data; many other new clusters also overlap with confirmed and
  candidate exoplanets.  Further studies that combine Gaia kinematics
  and TESS rotation periods are poised to expand the census of
