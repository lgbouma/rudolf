...
\begin{figure}[t]
    ...
    position and kinematics (see Appendix~\ref{app:kinematicselection}).
...
Kepler\,1627B, the planet orbits the G-dwarf primary, Kepler\,1627A (Section~\ref{sec:planet}).
Based on a correlation between the planetary transit times and the local
light curve slope, the orbit also seems to be prograde.  We
conclude by highlighting broader implications for our ability to
age-date a larger sample of planets (Section~\ref{sec:conc}).
...
high during the first half, and low in the second half.  
To determine
...
An important note is that even though this asymmetric feature is
within the plotted 2-$\sigma$ model uncertainties, this is within a
model that has a jitter term that grows to account for otherwise unmodelled 
white noise in the flux.
The significance of the asymmetry is therefore better assessed in
comparison against the intrinsic out-of-transit scatter, rather than the
model uncertainties.
