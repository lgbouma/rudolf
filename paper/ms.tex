...
\begin{abstract}
  ...
  periods seems likely to be a path toward expanding the census of
...
\begin{figure*}[tp]
  ...
  \caption{ {\bf The light curve of Kepler\,1627.}
    ...
    transits of \pn, as well as other deviations from the
    model.  The Figure Set online shows the
...
should enable similar crossmatches to
...
\begin{figure}[t]
	\begin{center}
		\leavevmode
		\includegraphics[width=0.49\textwidth]{f15supp.pdf}
	\end{center}
	\vspace{-0.7cm}
...
\begin{figure}[t]
	\begin{center}
		\leavevmode
		\includegraphics[width=0.49\textwidth]{f10.pdf}
	\end{center}
	\vspace{-0.7cm}
	\caption{
...
Our adopted model therefore included 10 free parameters for the
transit ($\{P,t_0,\log R_{\rm p}/R_\star,b,u_1,u_2,R_\star, \log g,
e\cos\omega, e\sin\omega \}$), 2 parameters for the light curve
normalization and uncertainty calibration ($\{\langle f \rangle,  \log
\sigma_f \}$), and 5 hyperparameters for the GP
($\{\sigma_{\mathrm{rot}}, \log P_{\mathrm{rot}}, \log Q_0, \log
...
\citep{hoffman_no-u-turn_2014}. We used $\hat{R}$ as our convergence
...
out of any of the quarters: a deviation of about 3\,ppt from
...
e.g.}, \citealt{morris_relationship_2020},
\citealt{plavchan_planet_2020}).  Young solar-type stars may also host
...
during transits, our reasoning is essentially that the expected
spot-crossing anomaly amplitudes ($\approx 100\,{\rm ppm}$) could be
correct; we are not able to definitely show that this is the correct
...
\begin{figure*}[tp]
	\begin{center}
		\leavevmode
		\subfloat{
			\includegraphics[width=0.49\textwidth]{f17a.pdf}
			\includegraphics[width=0.37\textwidth]{f17b.jpg}
		}

		\vspace{-0.1cm}
		\subfloat{
			\includegraphics[width=0.55\textwidth]{f6.pdf}
		}
	\end{center}
	\vspace{-0.7cm}
	\caption{
    ...
    of the $\delta$\,Lyr cluster.  Since other members of the cluster
...
this topic than ourselves could very well yield more detailed insights.
