...
\begin{abstract}
  ...
  flare arrival time distribution is most likely Poissonian, though
  there may be hints ($<3$-$\sigma$) of additional flares at the
  orbital and synodic periods.  In the future, spectroscopic studies
  of \pn\ may help clarify the evolution of this mini-Neptune's orbit
  and atmosphere.  More broadly, the combination of Gaia and TESS data
  offers an opportunity to expand the census of age-dated planets; we
  provide a literature concatenation of young stars to support this
  effort.
\end{abstract}
...
is often invoked to explain the observed radius distribution of 
mature exoplanets \citep{Fulton_et_al_2017}.
...
portion of the $\delta$\,Lyr cluster \citep{stephenson_possible_1959,eggen_photometric_1968}.
