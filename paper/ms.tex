...
\subsection{Is the Transit Asymmetry Robust?}
...
uncertainties.
We used the 15\,minute exposure time when numerically evaluating the
model.
...
optical spectrograph, or potentially also observations in the
