...
the expected velocity anomaly ($\Delta v_{\rm RM}\approx
20\,{\rm m\,s}^{-1}$) is a factor of two smaller than the
spot-corrected exposure-to-exposure scatter.  We are therefore not in
a position to claim a spectroscopic detection of the RM effect, nor a
precise quantification of the stellar obliquity.
...
possible through long-term monitoring of the transit times and
durations, or through a high-cadence multi-color radial velocity
campaign.  Measured at sufficient precision, the mass could yield
constraints on both the planet's composition and its initial entropy
...
planet-induced transit timing or duration variations,
...
with precise ages below 100\,Myr include K2-33, DS~Tuc, HIP~67522,
