...
\cn\ \citep{kounkel_untangling_2019}.  Given the statistical
...
(Section~\ref{sec:planet}), we confirm through two independent
approaches that despite a previously unreported binary companion, it
is a mini-Neptune orbiting the G-dwarf primary star.  We conclude by
...
\begin{figure}[t]
    ...
    four of them (orange points) have their names annotated.
...
\begin{figure*}[tp]
    ...
    field (background contours).  The right panel provides a closer
    view of stars on the pre-main-sequence.  The \cn\ and IC\,2602 are
    approximately the same isochronal age.  {\it Bottom:} TESS and
    Kepler stellar rotation period versus dereddened Gaia color, with
    the Pleiades (115\,Myr) and Praesepe (650\,Myr) shown for
...
combination of the isochronal, gyrochronal, and lithium-based
age-dating.
...
age measurement with an uncertainty, we used the empirical procedure
...
members of UCL, IC\,2602, and the Pleaides from
...
The age of the IC\,2602 cluster however is the most important
...
the \cn\ could help clarify the issue, but both are beyond our scope.
