...
Kinematics are reasonably compelling
(Appendix~\ref{app:kinematicselection}).
HR diagram in and of itself doesn't give any age information about the
star.   (Could quote funny literature isochrone ages).
Rotation is informative, and is consistent with cluster.
Final point: Lithium.  Quote your EW. 
All together, pretty good.  We adopt the age based on the pre-main-sequence
empirical fitting procedure from Section~\ref{sec:cmd}:
$35^{+6}_{-5}$\, Myr.



%FIXME FIXME FIXME
From the ensemble perspective, which
