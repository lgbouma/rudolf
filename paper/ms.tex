...
through a combination of automated and manual steps.  \deleted{As a matter of
scope, we restricted our attention to the \nkinwithtess\ stars
discussed in Section~\ref{sec:kinematicselection} in the spatial and
kinematic proximity of Kepler\,1627.}  
Kepler rotation periods were derived by
\citet{mcquillan_rotation_2014} for 28 of \replaced{these }{our \nkinwithtess\ }stars; for these cases, we
simply adopted the Kepler rotation period.
