...
which, if strong enough, can deplete or entirely strip the atmosphere \citep{lopez_how_2012,Owen_Wu_2013,ginzburg_corepowered_2018}.\added{ The latter photoevaporative and core-powered
...
For visual clarity, the latter two clusters are not shown in Figure~\ref{fig:age}.
}
We cleaned \replaced{these}{the membership lists}
...
kinematic proximity of Kepler\,1627. }
We extracted light curves from
...
for the model with a finite slope.  We view it as suggestive evidence
at best, particularly given the excess scatter in the transit timing
...
(CDPP) in the \sn\ light curve over the relevant transit timescales
...
the planetary interior, leading to a $\sim$10$^8$ year Kelvin-Helmholtz cooling and
...
also include that it is abnormally massive, or that it has an abnormally
