...
% More data will be needed however to
% make a more precise measurement of the stellar obliquity.
...
of the atmosphere \citep{spake_helium_2018,vissapragada_2020}.  Determining the
...
possible through timing analyses of the Kepler data,
...
star-planet interactions.  We encourage its
...
A more detailed spectroscopic analysis of the transit would however be
...
\begin{figure*}[t]
	\begin{center}
		\leavevmode
		\includegraphics[width=0.7\textwidth]{f13.pdf}
	\end{center}
	\vspace{-0.7cm}
	\caption{
