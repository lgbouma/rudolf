...
\title{
  ...
  Kepler 1627 Ab: A 38$\,$Myr Mini-Neptune in the Kepler Field
}
...
\clusterage.\footnote{Our own exploration of the PARSEC and MIST
isochrone models over a grid of ages, metallicities, and
reddenings, we yielded the best agreement for this $\approx 38\,$Myr age
as well, given ${\rm [Fe/H] = +0.1}$ and $A_V=0.2$
\citep{bressan_parsec_2012,choi_mesa_2016}.
