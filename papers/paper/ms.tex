...
correction.  Some, but not all, of the gradient in the $v_{l^*}$ {\it vs.}~$l$
...
positive rate of a few percent, at most.  In comparison, our \replaced{control}{comparison}
...
\added{in absolute reddening-corrected $G$-band magnitude as a function of $\bpmrpo$\ color}
...
involved a Monte Carlo procedure in which the continuum normalization
was allowed to vary through a bootstrap approach based on the local
scatter, and the line width itself was calculated by integrating a
single Gaussian over a local window.}  For Kepler-1643, this yielded a
