...
members are on a tight pre-main-sequence locus.  \added{Quantiatively,
...
($\sim$$8$\,Myr), and some \replaced{may}{do} still exist at ages of
LCC ($\sim$$16$\,Myr; \replaced{L.~Rebull
submitted}{\citealt{2022AJ....164...80R}}).  Regardless, since nearly
...
these M-dwarfs is not obvious.  \added{If none are cluster members,
...
This sets an upper bound on the contaminant fraction in our candidate
CH-2 members at about one in three.  The true value may be as low as 
one in six, based on our earlier CAMD analysis.
}
