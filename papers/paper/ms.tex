...
\added{This would be somewhat surprising since over a dozen
stars have already been analyzed in the relevant effective temperature range. However, considering}
...
\added{An alternative explanation could be that the overall metallicity of the cluster 
...
\replaced{This suggests}{Broadly, these considerations suggest} that
RSG-5 and Cep-Her could be
worthy objects for a \replaced{closer analysis of the lithium-rotation correlation}{spectroscopic analysis of lithium}
