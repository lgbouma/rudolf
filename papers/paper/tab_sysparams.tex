...
%  $a/R_\star$                                & $X$                & $+0.X$, $-0.X$             & D \\
  ...
  $t_{14}$~[hours]                           & $4.40$            & $0.21$                    & D \\
\enddata
\tablecomments{
  $^\dagger$The planet orbits KOI-7913 A (Section~\ref{subsec:validation}).
  ...
  (D) Kepler light curve.
  (E) HIRES/TRES \citep{bouma_2021_ngc2516}.
  (F) TRES SPC \citep{Buchhave2012,2021tsc2.confE.124B}.
