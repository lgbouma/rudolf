...
significant in greater depth in Appendix~\ref{app:spectra}, but
...
reduction was identical as before.  The images showed KOI-7913 A,
...
\pm 0.02^\circ$, with a $\Delta K' = 6.97 \pm 0.04$.  While it is too
...
the transit is flat and has a high S/N ($\approx 47$), which is
difficult to reproduce with eclipsing binary models.
...
revealed no new stellar companions.  Performing the validation
...
\citep{morton_false_2016,2017ksci.rept...16B}. 
...
our imaging shows that there are no neighboring sources that could
cause an offset of the observed amplitude.

\paragraph{KOI-7913}
KOI-7913.01 is also listed on the NASA Exoplanet Archive as a
