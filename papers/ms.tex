...
\begin{figure*}[t]
  ...
  The selection method for all of the stars 
...
these groups in space-velocity coordinates.  
In other words, the stars appear to be comoving, though with a
continuous gradient in velocity as a function of position
(Figure~\ref{fig:XYZvtang}, lower panels).
In this work, our primary interest in the region stems
...
10 and 12.5 days.  As previously noted, the age interpretation for these
...
Given its low density, in CH-2 truly a star cluster?  For this
...
large subset of the stars, and to determine whether the traceback approach
