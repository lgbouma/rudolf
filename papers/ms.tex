...
the planetary nature of the Cep-Her planets, for instance through
transit observations using a high-resolution spectrograph.  For now,
...
\begin{figure*}[!t]
    ...
    the population of young planets include {\it i)} their
...
because the planets are more massive than most mini-Neptunes.
