...
fourth-order polynomial, which was then divided out from the light
...
One weakness of our approach is that we have fixed 5 implicit
...
was short-term variability attributable to flares or instrumental
noise.  This failure mode is pernicious, in that it yields an
ill-founded sense of confidence in an ``overly clean'' transit model
