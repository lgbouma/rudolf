...
value does not correct for the \ion{Fe}{1} blend at 6707.44\,\AA,
because HIRES resolves the two features.  Given the purported age and
...
also density in velocity space.  Perhaps once stellar rotation
...
ability to discover stars that formed as part of the same event.
...
falls short of determining what the association looked like in
the past.  Our analysis of CH-2 meets the latter standard for the
existence of a $\approx$40\,Myr stellar assocation.  It would be a
...
\raggedbottom
% Cycle 3 and 4
L.G.B{.} acknowledges support from the Heising-Simons Foundation 51
...
from a preliminary version of that same catalog.  Note that more
