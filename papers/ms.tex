...
\begin{figure*}[tp]
	\begin{center}
		...
		\subfloat{
			\includegraphics[width=0.5\textwidth]{f3a.png}
			\includegraphics[width=0.5\textwidth]{f3b.png}
		}
	
		\subfloat{
			\includegraphics[width=0.5\textwidth]{f3c.png}
			\includegraphics[width=0.5\textwidth]{f3d.png}
		}
	\end{center}
	\vspace{-0.7cm}
	\caption{
