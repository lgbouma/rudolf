...
%Positive Probability table hosted at the NASA Exoplanet Archive, 
They
...
result: the transit is flat and has a reasonably
high S/N ($\approx 47$), which is difficult to reproduce with
eclipsing binary models.

Intriguingly, Kepler-1643 also formally failed the
centroid shift test (see the \texttt{q1\_q17\_dr25\_koi} data release),
with the angular distance between the target star position and the
location of the transiting source being measured as $1\farcs0$
at 4.4-$\sigma$ confidence.  There seem to be two outlying quarters
