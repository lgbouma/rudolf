...
format.  One entry is shown for guidance regarding form and content.  \added{Users who wish to minimize field star contamination should apply more restrictive weight cuts, {\it e.g.}, $\texttt{weight}>0.1$.}}
\vspace{-0.5cm}
\end{deluxetable}
