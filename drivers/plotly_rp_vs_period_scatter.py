...
def plot_rp_vs_period_scatter(
    ...
    fig = go.Figure()
    fig.add_trace(
        go.Scatter( x=sdf[s0]["pl_orbper"], y=sdf[s0]["pl_rade"],
                   hovertext=sdf[s0]["pl_name"], mode='markers',
                   marker=dict(
                       color='gray'
                   ),
                   name='>1 Gyr')
    ...
    fig.add_trace(
        go.Scatter(x=sdf[s1]["pl_orbper"], y=sdf[s1]["pl_rade"],
                   hovertext=sdf[s1]["pl_name"], mode='markers',
                   marker=dict(
                       size=12,
                       color=sdf[s1]["st_age_gyr"],
                       colorscale='Magma_r',
                       showscale=True
                   ),
                   name='<1 Gyr')
